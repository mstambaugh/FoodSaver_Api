...
namespace FoodSaverAPI.Migrations
{
    ...
    [Migration("20191106215551_EpicodusMac")]
    partial class EpicodusMac
    {
            ...
            modelBuilder.Entity("FoodSaverApi.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Directions = "1) Add ground beef and chili seasoning/chili powder to a large skillet and cook medium-high until browned. 2) Add diced onion, bell pepper, and garlic, cooking over medium heat and stirring regularly until onion is translucent. 3) Add diced tomatoes(drained), green chiles(drained), and beans (undrained), return to a boil, and reduce heat to medium-low. Simmer for 20 minutes, stirring occasionally. 4) Season with salt and pepper to taste (optional: try with additional spices, like cumin, oregano, or mix in a dash of brown sugar or hot sauce).",
