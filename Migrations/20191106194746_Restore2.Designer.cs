...
namespace FoodSaverAPI.Migrations
{
    ...
    [Migration("20191106194746_Restore2")]
            ...
            modelBuilder.Entity("FoodSaverApi.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            RecipeName = "Mac and Cheese Tuna Casserole",
                        ...
                        new
                        {
                            ...
                            RecipeTips = "This recipe is highyly cost effective over time; all ingredients are shelf-stable and under 50 cents per serving over time. Store leftover oatmeal in single serving plastic or glass storage containers that are microwave safe for fast and easy breakfasts and lunches, or use leftover oatmeal mixed with nuts or chocolate chips to make healthy cookie bars (spoon oatmeal and mixins onto a baking sheet and bake at 300 until lightly browned, approx. 10 minutes)."
                        },
                        new
                        {
                            RecipeId = 5,
                            ...
                            Directions = "1) Add ground beef and chili seasoning/chili powder to a large skillet and cook medium-high until browned 2) Add diced onion, bell pepper, and garlic, cooking over medium heat and stirring regularly until onion is translucent. 3) Add diced tomatoes(drained), green chiles(drained), and beans (undrained), return to a boil, and reduce heat to medium-low and simmer for 20 minutes, stirring occasionally. 4) Season with salt and pepper to taste (optional: try with additional spices, like cumin, oregano, or mix in a dash of brown sugar or hot sauce to taste.",
                        ...
                        new
                        {
                            ...
                            RecipeTips = "Leftover fritatta can be stored in the refrigerator for 3 days. Individually wrap leftover slices for easy lunches."
                        });
                });
